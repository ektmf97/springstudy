...
public class UploadServiceImpl implements UploadService {
	...
	@Transactional(readOnly = true) // INSERT문을 2개 이상 수행하기 때문에 트랙잰셕 처리가 필요하다.
	@Override
	public int addUpload(MultipartHttpServletRequest multipartRequest) {
		...
		// DB로 UploadDTO 보내기
		int uploadResult = uploadMapper.addUpload(uploadDTO); // <selectKey>에 의해서 uploadDTO 객체의 uploadNo 필드에
