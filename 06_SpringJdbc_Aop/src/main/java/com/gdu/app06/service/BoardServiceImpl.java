...
public class BoardServiceImpl implements BoardService {
	...
	public int addBoard(BoardDTO board) {
		return boardDAO.insertResult(board);
	}

	@Override
	public int modifyBoard(BoardDTO board) {
		return boardDAO.updatebBoard(board);
	}
	...
	public void testTx() {
		...
		// 성공하는 작업 
		boardDAO.insertResult(new BoardDTO(0, "트랜잭션제목", "트랜잭션내용", "트랜잭션작성자", null, null));
		
		// 실패하는 작업 
		boardDAO.insertResult(new BoardDTO()); // TITLLE 칼럼은 NOT NULL이기 때문에 Exception이 발생한다.
