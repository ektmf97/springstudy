...
public class SecondController {
	...
	public ResponseEntity<Map<String, Object>> bmi2(BmiVO bmiVO) {// 파라미터를 객체로 받음 
	 ...
	 * // MediaType.APPLICATION_JSON_VALUE는 "application/json"이다. public BmiVO
	 * bmi1(HttpServletRequest request, HttpServletResponse response) { return
	 * secondService.execute1(request, response); }
	 * 
	 * @ResponseBody
	 * 
	 * @GetMapping(value="/second/bmi2", produces=MediaType.APPLICATION_JSON_VALUE)
	 * public Map<String, Object> bmi2(BmiVO bmiVO){ return
	 * secondService.execute2(bmiVO); }
	 */
